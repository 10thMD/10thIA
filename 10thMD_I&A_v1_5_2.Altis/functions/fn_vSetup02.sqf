...
if (_t in _ifv) then
{
	switch (_t) do
	{
		...
		{
			/* Textures for Mora extracted from the "Norwegian Units" mod by Vasilyevich */
			_u setObjectTextureGlobal [0,'scripts\vehicle\textures\gorgon_body.paa'];
			_u setObjectTextureGlobal [1,'scripts\vehicle\textures\gorgon_extras.paa'];
			_u setObjectTextureGlobal [2,'scripts\vehicle\textures\gorgon_turret.paa'];
			_u setObjectTextureGlobal [3,'scripts\vehicle\textures\gorgon_extras.paa'];			
			/////////////////////////////////////////////////////////////////////////
		...
		{
			/* Textures for Mora extracted from the "Norwegian Units" mod by Vasilyevich */
			_u setObjectTextureGlobal [0,'scripts\vehicle\textures\mora_turret.paa']; 
			_u setObjectTextureGlobal [1,'scripts\vehicle\textures\mora_body.paa'];
			_u setObjectTextureGlobal [2,'scripts\vehicle\textures\mora_body.paa'];
			_u setObjectTextureGlobal [3,'scripts\vehicle\textures\mora_body.paa'];
			/////////////////////////////////////////////////////////////////////////
			_u addMagazineTurret ["140Rnd_30mm_MP_shells_Tracer_Yellow",[0]];
			_u addMagazineTurret ["140Rnd_30mm_MP_shells_Tracer_Yellow",[0]];
			_u addMagazineTurret ["60Rnd_30mm_APFSDS_shells_Tracer_Yellow",[0]];
...
{
	_u addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
	_u addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
	_u addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
	_u addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
};